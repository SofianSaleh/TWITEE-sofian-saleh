...
var transporter = nodemailer_1.default.createTransport({
    service: "".concat(process.env.SERVICE),
    auth: {
        user: "".concat(process.env.EMAIL_USER),
        pass: "".concat(process.env.EMAIL_PASS),
    },
});
var sendMail = function (info) { return __awaiter(void 0, void 0, void 0, function () {
    var mailOptions, emailVerification, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                mailOptions = {
                    from: "".concat(process.env.EMAIL_USER),
                    to: info.email,
                    subject: "Welcome to Twitter Clone\"",
                    html: "<h1>From Sofian Test twitter clone</h1>\n        <p> Welcome to our wbsite we hope you enjoy our services </p>\n        <p> Here are your credentials </p>\n        <ul> Here are your credentials </ul>\n        <li> Email: ".concat(info.email, " </li>\n        <li> Name: ").concat(info.name, " </li>\n        "),
                };
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
