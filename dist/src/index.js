...
app.get("/healthcheck", function (_req, res) { return res.sendStatus(200); });
app.get("/", function (_req, res) { return res.sendStatus(200); });
app.use("/api/auth", auth_routes_1.default);
app.use("/api/tweet", tweet_routes_1.default);
app.use("/api/comment", comment_routes_1.default);
app.use("/api/like", like_routes_1.default);
app.listen(port, function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, connect_1.default)()];
            case 1:
                _a.sent();
                (0, swagger_1.default)(app, port);
                logger_1.default.info("Listening on port http://localhost:".concat(port));
                return [2];
        }
    });
}); });
