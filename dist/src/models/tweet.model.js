...
var TweetSchema = new mongoose_1.default.Schema({
    content: { type: String, required: true },
    likedUser: [{ type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User' }],
...
TweetSchema.pre('remove', function (next) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, comment_model_1.default.deleteMany({
                        _id: {
                            $in: this.comments,
                        },
                    })];
...
var TweetModel = mongoose_1.default.model('Tweet', TweetSchema);
